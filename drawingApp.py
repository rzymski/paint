...
class DrawingApp:
    ...
    def initLabelsAndButtons(self, screen_height):
        ...
        self.radio_line = tk.Radiobutton(self.root, text="Line", variable=self.draw_type, value="line", command=self.onRadioButtonSelect)
        self.radio_rect = tk.Radiobutton(self.root, text="Rectangle", variable=self.draw_type, value="rectangle", command=self.onRadioButtonSelect)
        self.radio_circle = tk.Radiobutton(self.root, text="Circle", variable=self.draw_type, value="circle", command=self.onRadioButtonSelect)
        ...
        self.param_x = tk.Entry(self.root)
        self.param_y = tk.Entry(self.root)
        self.param_width = tk.Entry(self.root)
        self.param_height = tk.Entry(self.root)
        self.param_radius = tk.Entry(self.root)
        ...
        self.draw_button = tk.Button(self.root, text="Draw with Parameters", command=self.drawWithParameters)
        self.draw_button.place(x=205, y=screen_height-110)
        # Button to trigger change with parameters
        self.change_button = tk.Button(self.root, text="Change with Parameters", command=self.changeWithParameters)
        ...
        self.label_radius = tk.Label(self.root, text="Radius:")
